...
const AnimatedQuotesGrid = () => {
  ...
  const quotes = [
    {
      text: "I am in awe of how you can see what we have written and see what we should have done",
      author: "Academic module leader",
      gradient: "from-cyan-300 to-blue-300",
      bgGradient: "from-cyan-500/25 to-blue-500/25"
    },
    {
      text: "it has been such a pleasure to work with you on this module, thank you",
      author: "Academic module leader",
      ...
      <div className="relative max-w-6xl w-full">
        ...
        <div className={`text-center mb-10 transition-all duration-500 ${isAnimating ? 'opacity-100' : 'opacity-0'}`}>
          <h1 className="text-4xl lg:text-5xl font-bold text-white">
            Academic module leader feedback
          </h1>
        </div>
