...
const AnimatedQuotesGrid = () => {
  ...
  const quotes = [
    {
      text: "This was the best course I took as part of the GMBA program",
      author: "Student",
      gradient: "from-cyan-300 to-blue-300",
      bgGradient: "from-cyan-500/25 to-blue-500/25"
    },
    {
      text: "One of my favorite weeks … it takes us into the mind of the PE advisor",
      author: "Student",
      gradient: "from-purple-300 to-pink-300",
      bgGradient: "from-purple-500/25 to-pink-500/25"
    },
      {
      text: "The course content was highly interesting, engaging, and up-to-date.",
      author: "Student",
      gradient: "from-purple-300 to-pink-300",
      bgGradient: "from-purple-500/25 to-pink-500/25"
    }
