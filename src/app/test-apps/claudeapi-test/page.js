...
import { ImageIcon, VideoIcon, Copy, RotateCcw, Send, Loader2 } from "lucide-react";
...
const PromptImproverPage = () => {
  ...
  const handlePromptTypeSelect = (type) => {
    ...
    setMessages([{ 
      role: "assistant", 
      content: `Great! You're working on a prompt for a **${type}**. Paste your initial prompt below, and I'll help you refine it using AI prompt engineering best practices.` 
    }]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/test-apps/claudeapi-test/api", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          promptType: promptType,
          currentPrompt: currentPromptToRefineForAPI,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex flex-col p-4">
      ...
      {!promptType ? (
        ...
        <div className="flex-grow w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 overflow-hidden">
          {/* Analysis Panel */}
            ...
            <div className="flex-grow overflow-y-auto">
              {structuredAnalysis ? (
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    {structuredAnalysis.revisedFullPrompt && (
                      ...
                      >
                        {isRevisedPromptCopied ? <span className="text-xs px-1">Copied!</span> : <Copy className="h-4 w-4" />}
                      </button>
                    )}
                  </div>
                ...
                <p className="text-gray-500 text-center mt-10">
                  Enter your {promptType} prompt in the chat to see the AI analysis.
                </p>
              )}
            </div>
          </div>
            ...
            <div ref={chatContainerRef} className="flex-grow p-6 space-y-4 overflow-y-auto">
              ...
              {loading && (
                <div className="flex justify-start">
                  <div className="bg-gray-200 text-gray-800 p-3 rounded-xl shadow flex items-center">
            ...
            <div className="p-4 border-t border-gray-200 bg-white rounded-b-lg flex-shrink-0">
             <div className="flex items-center space-x-2">
                <textarea 
                  ...
                  placeholder={promptType ? `Enter your ${promptType} prompt or refinement request...` : "Select prompt type first"} 
                  rows={3} 
