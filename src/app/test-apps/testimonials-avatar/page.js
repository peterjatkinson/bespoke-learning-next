...
const AnimatedQuotesGrid = () => {
  ...
  const quotes = [
    {
      text: "I did not even notice the lecturer was an avatar",
      author: "Student",
      gradient: "from-cyan-300 to-blue-300",
      bgGradient: "from-cyan-500/25 to-blue-500/25"
    },
    {
      text: "The experience is very similar to the real presenters",
      author: "Student",
      gradient: "from-purple-300 to-pink-300",
      bgGradient: "from-purple-500/25 to-pink-500/25"
    },
    {
      text: "This is a great initiative ... efficient and effective overall",
      author: "Student",
      gradient: "from-emerald-300 to-teal-300",
      bgGradient: "from-emerald-500/25 to-teal-500/25"
    },
    {
      text: "a groundbreaking approach and it was executed very well!",
      author: "Academic module leader",
