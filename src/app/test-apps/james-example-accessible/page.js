    ...
    <div className="p-6 max-w-4xl mx-auto">
        ...
        <table className="min-w-full bg-white border border-gray-300">
          <caption className="caption-top text-left text-lg font-semibold mb-2">
            ...
            <tr className="bg-gray-100">
              ...
              <th scope="col" className="py-3 px-6 text-left border-b">Total revenue (£)</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className="mt-8">
        ...
        <button
          ...
          className="mt-6 bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded
