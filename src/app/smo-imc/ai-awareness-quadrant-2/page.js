...
const VisualView = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="lg:col-span-1 bg-white p-6 rounded-2xl shadow-lg border-4 border-black">
...
const AccessibleView = ({ companies, onSave, isLoading, hasSubmitted }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-lg border-4 border-black">
